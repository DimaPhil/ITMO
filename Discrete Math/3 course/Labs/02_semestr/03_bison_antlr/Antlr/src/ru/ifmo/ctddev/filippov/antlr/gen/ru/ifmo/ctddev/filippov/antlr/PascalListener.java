...
public interface PascalListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link PascalParser#eval}.
	 * @param ctx the parse tree
	 */
	void enterEval(PascalParser.EvalContext ctx);
	/**
	 * Exit a parse tree produced by {@link PascalParser#eval}.
	 * @param ctx the parse tree
	 */
	void exitEval(PascalParser.EvalContext ctx);
	/**
	 * Enter a parse tree produced by {@link PascalParser#programStart}.
	 * @param ctx the parse tree
	 */
	void enterProgramStart(PascalParser.ProgramStartContext ctx);
	/**
	 * Exit a parse tree produced by {@link PascalParser#programStart}.
	 * @param ctx the parse tree
	 */
	void exitProgramStart(PascalParser.ProgramStartContext ctx);
	/**
